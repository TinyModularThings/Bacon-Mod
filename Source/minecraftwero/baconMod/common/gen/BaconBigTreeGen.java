...
public class BaconBigTreeGen extends WorldGenerator
{
    ...
    {
    	this(par1, BaconItems.baconMachine.getblock, 4, BaconItems.baconMachine.blockID, 5);
    }
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, byte par5)
    {
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                {
                    aint1[b2] = aint[b2] + k1;
                    int l1 = this.worldObj.getBlockMetadata(aint1[0], aint1[1], aint1[2]);
    ...
    private void setBlockAndMetadata(World worldObj2, int i, int j, int k,
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                int k = this.worldObj.getBlockMetadata(aint3[0], aint3[1], aint3[2]);
    ...
    boolean validTreeLocation()
    {
        ...
        int i = this.worldObj.getBlockMetadata(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
